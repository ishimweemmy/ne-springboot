package com.ishimweemmy.templates.springboot.v1.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.ishimweemmy.templates.springboot.v1.payload.response.ApiResponse;
import com.ishimweemmy.templates.springboot.v1.security.CustomUserDetailsService;
import com.ishimweemmy.templates.springboot.v1.security.JwtAuthenticationEntryPoint;
import com.ishimweemmy.templates.springboot.v1.security.JwtAuthenticationFilter;
...
public class WebSecurity {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable).authorizeHttpRequests(request -> request
                .requestMatchers("/api/v1/auth/**", "/api/v1/files/load-file/**", "/api/v1/users/register",
